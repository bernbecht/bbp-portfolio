...
export function Hero() {
  return (
    <section className="hero-frame grid grid-cols-1 border-x border-t border-strong layout:grid-cols-12">
      <div className="col-span-full flex flex-wrap items-center justify-between gap-3 border-b border-strong px-4 py-3 font-mono text-[11px] uppercase tracking-[0.14em] sm:px-6">
      ...
      <div className="col-span-full px-4 pb-12 pt-8 sm:px-6 layout:col-span-8 layout:border-r layout:border-strong layout:pb-16 layout:pt-12">
        <h1 className="max-w-4xl type-display">
          ...
          <span className="font-serif italic tracking-[-0.045em]">from design to code.</span>
        </h1>
        <p className="section__paragraph mt-8 max-w-2xl type-body text-secondary md:text-xl">
          ...
          accessibility. I build interfaces, reusable components, and tools that
          help teams develop and test their UI.
        </p>
      ...
      <div className="col-span-full grid grid-cols-3 border-t border-strong font-mono text-[10px] uppercase tracking-wider sm:text-xs">
        <p className="border-r border-strong px-3 py-3 sm:px-5">01 · UI engineering</p>
        <p className="border-r border-strong px-3 py-3 sm:px-5">02 · Design systems</p>
